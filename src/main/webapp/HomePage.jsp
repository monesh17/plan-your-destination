...
<spring:url value="/img/bali.jpg" var="bali" />
<spring:url value="/img/disneyland.jpg" var="disneyland" />
<spring:url value="/img/Singapore.jpg" var="Singapore" />
<spring:url value="/js/calendar.js" var="calendarjs" />
<spring:url value="/js/initialize.js" var="initializejs" />
<spring:url value="/css/Calendar.css" var="calendarcss"/>
<spring:url value="/css/Layout.css" var="layout"/>
...
<script src="${initializejs}"></script>

<body class="w3-light-grey">
<!-- Navigation Bar -->
<div class="w3-bar w3-white w3-border-bottom w3-xlarge">
  <a href="#" class="w3-bar-item w3-button w3-text-blue w3-hover-blue"><b><i class="fa fa-map-marker w3-margin-right"></i>Plan Your Destination</b></a>
  <a href="#" class="w3-bar-item w3-button w3-right w3-hover-blue w3-text-grey"><i class="fa fa-search"></i></a>
</div>   
<!-- Header --> 
<div class="bali w3-display-container w3-opacity-min">
  <div class="w3-display-middle1" style="width:65%" >
    <div class="w3-bar w3-black">
     <!--  <button id='flightbutton' class="w3-bar-item w3-button tablink" ng-click="tabevent('flight')"><i class="fa fa-plane w3-margin-right"></i>Flight</button> -->
     <button class="w3-bar-item w3-button tablink" onclick="openLink(event, 'Flight');"><i class="fa fa-bed w3-margin-right"></i>Flight</button>
    ...
    <div id="Flight" class="w3-container w3-white w3-padding-16 myLink" style="display:block;">
      ...
      <div class="w3-row-padding" style="margin:0 -16px;">
        <div class="w3-half" >
          <label>From</label>
          <input id="from" class="w3-input w3-border" type="text"  placeholder="Departing from" data-calendar='true'>
        </div>
        <div class="w3-half" >
          <label>To</label>
          <input id="to" class="w3-input w3-border" type="text" placeholder="Arriving at" data-calendar='true'> 
        </div>
        <own:Hello id="own id"/>
      </div>
    ...
    <div id="Hotel" class="w3-container w3-white w3-padding-16 myLink"  style="display:block;">
    ...
    <div id="Car" class="w3-container w3-white w3-padding-16 myLink"  style="display:block;">
